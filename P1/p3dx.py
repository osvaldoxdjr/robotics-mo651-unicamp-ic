    ...
    try:
        while True:
			...
			if j == 0:
				...
				iniLeftAngle = simxGetJointPosition(clientID, leftMotorHandle, vrep.simx_opmode_streaming)
				iniRightAngle = simxGetJointPosition(clientID, rightMotorHandle, vrep.simx_opmode_streaming)
			else:
				angleEncLeft = simxGetJointPosition(clientID, leftMotorHandle, vrep.simx_opmode_streaming)
				angleEncRight = simxGetJointPosition(clientID, rightMotorHandle, vrep.simx_opmode_streaming)
		...
		plt.plot(cloudPointY, cloudPointX, 'g')
        plt.show()
